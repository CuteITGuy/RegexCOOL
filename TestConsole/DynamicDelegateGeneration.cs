...
{
    public class DynamicDelegateGeneration<TDelegate> where TDelegate: class
    {
        #region  Fields
        ...
        static DynamicDelegateGeneration()
        {
        ...
        private static void AddDefaultAssemblies(StringCollection referencedAssemblies)
        {
            ...
            if (!referencedAssemblies.Contains(tDelegateAssembly))
            {
                referencedAssemblies.Add(tDelegateAssembly);
            }
        }
